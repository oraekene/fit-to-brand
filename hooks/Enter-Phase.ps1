...
$prompts = @{
  ...
  'Q13.1' = 'Do you accept the stop rules? Self-serve messages stop below a response floor after 1,000 views. Sales-led messages stop after one pipeline review. Mix-ups above 1 in 10 stop a message. Accept them (recommended) / adjust per placed message.'

...
$prompts = @{
  ...
  'Q0.2'  = 'Which video service do we use? same service as pictures (recommended) / different service from list / still pictures only / by hand.'
  'Q0.2m' = 'Which video model do we use? recommended first. Skipped unless you pick a different video service.'
  ...
  'Q1.1'  = 'What is the scope? single (one product, recommended for a product launch) / category (whole category).'
  'Q1.2'  = 'Which market setup do we use? O-GTM (sell products, recommended) / O-OPS (field operations) / O-EDU (learning) / O-SUBSISTENCE (trade without money) / custom (you define it later).'
  'Q1.3'  = 'Do you accept the size limits 300/50/10? Accept them (recommended) / tighten them / loosen them (give numbers).'
  'Q1.4'  = 'Which promises can we make? Give the promises we can make, the forbidden promises, and the certificates you hold. For example: ''charges three phones a day'' is a promise we can make, and ''cools the room'' is forbidden. A certificate proves a regulated promise, like a CE mark behind ''meets EU safety rules''. TBD is a legal answer and stays flagged.'
  'Q3.1'  = 'Which currency and year do we use? USD and the current year (recommended) / another currency and year (name them) / staple amounts (for trade without money).'
  'Q3.3'  = 'Which visual reference do we use? Approve my pick (recommended if you agree) / send another image / describe the direction in words.'
  'Q4.1'  = 'Rank the top two winning differences: price / performance / distribution / compatibility. Asked only in whole-category runs.'
  'Q4.2'  = 'Which binding rules touch this work? product certificates (UL, CE, FDA, DOT) / operation rules (ROE, LOAC) / curriculum standards / local custom / none-known. TBD is a legal answer and stays flagged.'
  'Q4.3'  = 'Which promises are forbidden? Write them in your own words, or answer none-known.'
  'Q5.1'  = 'Are the groups right? Accept them (recommended) / add / merge / split (name them).'
  'Q5.2'  = 'How do we sell to each group (self-serve or sales-led, or your setup''s words)? Accept my proposal (recommended) / correct per group.'
  'Q6.1'  = 'Do we import the groups, the positioning, and the promises word for word? Yes (recommended) / adjust (say exactly what).'
  'Q7.1'  = 'Do you approve all three? Approve them (recommended) / adjust a named item / reject them and restart.'
  'Q8.1'  = 'Which font system do we use, A or B? A (recommended) / B / neither (say what to change).'
  'Q9.1'  = 'Do you agree with the review marks? Accept them (recommended) / contest named items.'
  'Q9.2'  = 'Do you accept my recommendation? I recommend refine or restart and show the triggers. Accept it (recommended) / override it and say which triggers you see differently.'
  'Q9.3'  = 'Do you approve the locked design? Approve it (recommended) / adjust a named rule / reject the direction. Say yes in your own words.'
  'Q10.1' = 'Which guideline chapters (one topic each) do we make? Pick one or more (recommended: the marked minimum).'
  'Q11.1' = 'Is the product version list right? Accept it (recommended) / amend it.'
  'Q11.2' = 'Are the owners right? Accept them (recommended) / correct an owner.'
  'Q11.3' = 'Which formats and details can change at scale? Accept it (recommended) / amend it.'
  'Q12.1' = 'Do you accept the six packaging views? Accept them (recommended) / amend them.'
  'Q12.2' = 'Do you sign the final review? Sign (recommended when it passes) / hold a named item.'
  'Q13.1' = 'Do you accept the stop rules? Some stop a message, and some change its direction. Self-serve messages stop below a response floor after 1,000 views. Sales-led messages stop after one pipeline review. Mix-ups above 1 in 10 stop a message. Accept them (recommended) / adjust per placed message.'
  'Q14.1' = 'Do you accept the flight decisions? Accept them (recommended) / override a named one with a reason.'
  'Q14.2' = 'Do you stop a group or hold a launch? Say yes to each one alone, in your own words. There is no default.'
  'QR.1'  = 'Which parts stay? keep / negotiable / drop per part. There is no default.'
  'QR.2'  = 'Do you accept the proposed regroup? Accept it (recommended) / change named groups.'
  'QR.3'  = 'How long do remaining and new packs share the shelf? 8 weeks (recommended) / another timing (name it).'
  'QC.1'  = 'Which placed messages fly? Pick one or more (recommended: proven ones first).'
